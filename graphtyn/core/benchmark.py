...
def syntactically_complete_answer(answer: str) -> bool:
    """Conservative signal for provider responses ending mid-sentence."""
    answer = str(answer or "").strip()
    return bool(answer) and (len(answer) >= 500 or answer[-1] in ".!?)]}`\"'")
