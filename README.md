...
> Última versión estable publicada: [`0.10.1`](https://github.com/CaleroAM/graphtyn/releases/tag/v0.10.1).
...
```bash
python -m pip install "https://github.com/CaleroAM/graphtyn/releases/latest/download/graphtyn-0.10.1-py3-none-any.whl"
```
